...
function competitionPeakBlocks(day,week){
  ...
  if(day === "lundi") return [
    ...
    {time:"7 min",title:"C. Reset moteur",tag:"Recovery",kind:"accessory",
     exercises:[cpEx("Bike facile",taper?"5 min":"6 min","zone 2","—","Faire redescendre le système. Tu dois finir mieux, pas écrasé.")]},
  ...
  return [
    ...
    {time:taper?"6 min":"7 min",title:"A. Prep spécifique",tag:"Primer",kind:"main",
     exercises:[cpEx("Primer transitions",taper?"3 tours faciles":"3-4 tours","6 reps / mouvement","0:45","Tester le rythme du WOD sans créer de fatigue.")]},
