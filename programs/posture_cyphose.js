...
function postureBlocks(day, week){
  ...
  if(day === "lundi") return [
    ...
    {time:"12 min", title:"B. Serratus + trap inférieur", tag:"Correctif", kind:"accessory",
     ...
     exercises:[
       pstEx("B1. Serratus Cable Punch", p.accessorySets + "/côté", w1?"léger":"léger à modéré", "0:30 avant B2", "Cage basse. Protraction complète sans hausser l'épaule."),
       pstEx("B2. Trap-3 Raise", p.accessorySets, "léger", "1:00 après B2", "Pouce vers le haut. Cherche le trap inférieur, pas le trap supérieur.")
     ]},
  ...
  if(day === "mardi") return [
    ...
    {time:"12 min", title:"B. Fessiers + gainage anti-extension", tag:"Correctif", kind:"accessory",
     exercises:[
       pstEx("B1. Hip Thrust", w1?"3×10":w3?"4×8":"4×10", p.hipLoad, "0:45 avant B2", "Pause en haut. Bassin neutre, pas d'hyperextension."),
       pstEx("B2. Dead Bug", w1?"3×8/côté":"3×10/côté", "poids du corps", "1:00 après B2", "Côtes basses, expiration longue, contrôle total.")
     ]},
  ...
  if(day === "jeudi") return [
    ...
    {time:"12 min", title:"B. Scapula overhead", tag:"Correctif", kind:"accessory",
     exercises:[
       pstEx("B1. Wall Slide Lift-off", w1?"3×8":"3×10", "poids du corps", "0:30 avant B2", "Lent. Rotation supérieure sans trap supérieur."),
       pstEx("B2. Face Pull to External Rotation", p.accessorySets, w1?"léger":"léger à modéré", "1:00 après B2", "Rotation externe propre, coudes hauts, cou relâché.")
     ]},

    {time:"10 min", title:"C. Tirage vertical contrôlé", tag:"Accessoire", kind:"accessory",
     exercises:[
       pstEx("C1. Weighted Pull-up", w1?"3×5 strict":w3?"4×5":"3×6", p.pullLoad, "1:15", "Strict, amplitude propre. Remplacer par ring rows si coudes sensibles."),
       pstEx("C2. Serratus Wall Slide", w1?"3×10":"3×12", "mini-band optionnel", "0:45", "Pousser le mur, cage basse.")
     ]},
  ...
  return [
    ...
    {time:"12 min", title:"B. Full body correctif", tag:"Correctif", kind:"accessory",
     exercises:[
       pstEx("B1. Goblet Squat Tempo", w1?"3×8":w3?"4×8":"3×10", w1?"24 kg":"24-32 kg", "0:30 avant B2", "Tempo 3 sec descente. Torse haut, respiration calme."),
       pstEx("B2. Ring Row Strict", w1?"3×8":w3?"4×8-10":"3×10-12", "poids du corps", "1:00 après B2", "Poitrine aux anneaux, omoplates fortes.")
     ]},

    {time:"10 min", title:"C. Reset scapula / core", tag:"Accessoire", kind:"accessory",
     exercises:[
       pstEx("C1. Pallof Press", w1?"3×10/côté":"3×12/côté", "léger à modéré", "0:30", "Anti-rotation. Bassin stable."),
       pstEx("C2. Band Pull Apart", w1?"3×20":w3?"3×30":"3×25", "élastique", "0:45", "Volume facile, qualité posturale.")
     ]},
