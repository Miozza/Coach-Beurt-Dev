    ...
    getBlocks: function(day, week, ctx) {
      ...
      if(day==="lundi") return [
        ...
        {time:"10 min", title:"B. Lockout / triceps", tag:"Triceps", kind:"accessory",
          ...
          exercises:[
            {name:"B1. Close-Grip Bench Press", format:deload?"2×8 léger":week>=13?"2×5 léger/modéré":"3×6-8", load:deload?"léger":week>=13?"RPE 6-7":"RPE 7-8", rest:"0:45 avant B2", note:"Aide le lockout sans transformer lundi en deuxième journée bench lourde."},
            {name:"B2. Overhead Rope Extension", format:deload?"2×12":"3×10-15", load:"modéré", rest:"1:00 après B2", note:"Longue portion du triceps. Coude stable."}
          ]},
        {time:"8 min", title:"C. Stabilité overhead", tag:"Stabilité", kind:"accessory",
          exercises:[
            {name:"C1. Overhead Hold", format:deload?"2×20 sec":"3×20-30 sec", load:"modéré", rest:"0:45 avant C2", note:"Lockout stable, côtes basses."},
            {name:"C2. Dead Bug", format:"3×8/côté", load:"contrôle", rest:"0:45 après C2", note:"Anti-extension. Protéger le bas du dos."}
          ]},
      ...
      if(day==="mardi") return [
        ...
        {time:"12 min", title:"B. Unilatéral + core", tag:"Jambes / Core", kind:"accessory",
          exercises:[
            {name:"B1. Bulgarian Split Squat", format:lp.bulgarian, load:deload?"léger":"45-55 lb / main", rest:"0:45 avant B2", note:"Stable, amplitude propre."},
            {name:"B2. Pallof Press", format:"3×10/côté", load:"contrôle", rest:"0:45 après B2", note:"Anti-rotation. Tronc solide pour le dip-drive."}
          ]},
        {time:"11 min", title:"C. Chaîne postérieure", tag:"Fessiers / Ischios", kind:"accessory",
          exercises:[
            {name:"C1. Hip Thrust", format:lp.hip, load:deload?"léger":"RPE 7-8", rest:"0:45 avant C2", note:"Drive de hanches utile sans surcharger les épaules."},
            {name:"C2. DB RDL", format:lp.rdl, load:deload?"léger":"60-70 lb / main", rest:"1:00 après C2", note:"Ischios/fessiers, dos neutre. Aucun ego."}
          ]},
      ...
      if(day==="vendredi") return [
        ...
        {time:"12 min", title:"A. Carries / grip", tag:"Carries", kind:"main",
          exercises:[
            {name:"A1. Farmer Carry", format:deload?"2×30 m":"4×40 m", load:"lourd propre", rest:"0:45 avant A2", note:"Tronc rigide. Ne pas transformer en grip max."},
            {name:"A2. Front Rack Carry", format:deload?"2×20 m":"3×30 m", load:"modéré", rest:"1:00 après A2", note:"Rack solide, respiration contrôlée."}
          ]},
        {time:"10 min", title:"B. Haut du corps durable", tag:"Accessoire", kind:"accessory",
          exercises:[
            {name:"B1. DB Bench Press", format:deload?"2×10":"3×8-12", load:deload?"léger":"modéré", rest:"0:30 avant B2", note:"Volume utile sans stress lourd."},
            {name:"B2. Hammer Curl", format:deload?"2×12":"3×10-12", load:"modéré", rest:"0:45 après B2", note:"Coudes, grip, bras forts."}
          ]},
