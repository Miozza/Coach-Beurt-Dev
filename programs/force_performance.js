...
function forceWeekPlan(week){
  return ({
    1:{
      ...
      bench:"5×5",benchLoad:"240 lb",
      row:"4×6-8",rowLoad:"165 lb",pull:"4×5",pullLoad:"+10 à +25 lb",
      cgb:"3×6-8",cgbLoad:"185 lb",face:"3×15-20",
      squat:"5×5",squatLoad:"205 lb",
      deadlift:"3×5",deadliftLoad:"205-225 lb",
      hip:"3×8-10",hipLoad:"255-275 lb",step:"3×10/jambe",
      clean:"6×2",cleanLoad:"165 lb",
      press:"4×5",pressLoad:"125 lb",
      dip:"4×5",dipLoad:"+10 à +25 lb",ctb:"4×4-6",
      front:"4×5",frontLoad:"165-175 lb",
      dbBench:"3×10",dbBenchLoad:"60 lb / main",carry:"4×40 m",
      wodNote:"court et contrôlé"
    },
    2:{
      label:"S2 Volume",note:"Volume lourd. +5 à +10 lb si S1 était propre.",
      bench:"5×4",benchLoad:"250 lb",
      row:"5×6-8",rowLoad:"175 lb",pull:"5×5",pullLoad:"+15 à +30 lb",
      cgb:"3×6-8",cgbLoad:"195 lb",face:"3×15-20",
      squat:"5×4",squatLoad:"215 lb",
      deadlift:"4×4",deadliftLoad:"225-245 lb",
      hip:"4×8",hipLoad:"275-295 lb",step:"3×12/jambe",
      clean:"7×2",cleanLoad:"175 lb",
      press:"5×4",pressLoad:"130 lb",
      dip:"5×5",dipLoad:"+15 à +30 lb",ctb:"5×4-6",
      front:"4×4",frontLoad:"175-185 lb",
      dbBench:"3×10",dbBenchLoad:"65 lb / main",carry:"4×40 m lourd",
      wodNote:"modéré, pas redline"
    },
    3:{
      label:"S3 Densité",note:"Semaine force + densité. Le cardio ne doit pas voler les lifts.",
      bench:"6×3",benchLoad:"260 lb",
      row:"5×5-6",rowLoad:"185 lb",pull:"5×4-5",pullLoad:"+20 à +35 lb",
      cgb:"3×5-6",cgbLoad:"205 lb",face:"3×15-20",
      squat:"6×3",squatLoad:"225 lb",
      deadlift:"5×3",deadliftLoad:"245-265 lb",
      hip:"4×6-8",hipLoad:"295-315 lb",step:"3×12-15/jambe",
      clean:"8×1",cleanLoad:"185 lb",
      press:"5×3",pressLoad:"135 lb",
      dip:"5×4-5",dipLoad:"+20 à +35 lb",ctb:"5×4-5",
      front:"5×3",frontLoad:"185-195 lb",
      dbBench:"4×8",dbBenchLoad:"65-70 lb / main",carry:"5×40 m lourd",
      wodNote:"dense mais contrôlé"
    },
    4:{
      label:"S4 Surcharge",note:"Charges sérieuses. RPE 8-9 max. Aucun grind laid.",
      bench:"5×3",benchLoad:"265 lb",
      row:"4×5",rowLoad:"195 lb",pull:"4×4",pullLoad:"+25 à +40 lb",
      cgb:"3×5",cgbLoad:"210-215 lb",face:"2×15-20",
      squat:"5×3",squatLoad:"235 lb",
      deadlift:"4×3",deadliftLoad:"265-285 lb",
      hip:"3×6",hipLoad:"315 lb",step:"3×10/jambe",
      clean:"6×1",cleanLoad:"195 lb",
      press:"5×3",pressLoad:"140 lb",
      dip:"4×3-5",dipLoad:"+25 à +40 lb",ctb:"4×3-5",
      front:"5×3",frontLoad:"195 lb",
      dbBench:"3×8",dbBenchLoad:"70 lb / main",carry:"4×40 m très lourd",
      wodNote:"très court"
    },
    5:{
      label:"S5 Peak",note:"Peak force. Peu de volume. Tu dois finir nerveux, pas détruit.",
      bench:"3×2 lourd",benchLoad:"275-285 lb",
      row:"4×4",rowLoad:"195-205 lb",pull:"4×3 lourd",pullLoad:"+30 à +45 lb",
      cgb:"2×5",cgbLoad:"205 lb",face:"2×15",
      squat:"3×2 lourd",squatLoad:"245-255 lb",
      deadlift:"3×2 lourd propre",deadliftLoad:"285-305 lb",
      hip:"2×6",hipLoad:"295-315 lb",step:"2×10/jambe",
      clean:"5×1 lourd",cleanLoad:"200-210 lb",
      press:"3×2",pressLoad:"145-150 lb",
      dip:"4×3 lourd",dipLoad:"+30 à +45 lb",ctb:"4×3",
      front:"4×2 lourd",frontLoad:"195-205 lb",
      dbBench:"3×6-8",dbBenchLoad:"70 lb / main",carry:"4×30-40 m lourd",
      wodNote:"minimal"
    },
    6:{
      label:"S6 Deload",note:"Deload. Bar speed, mobilité, récupération. Aucun test.",
      bench:"3×5 léger",benchLoad:"210 lb",
      row:"2×8 léger",rowLoad:"135 lb",pull:"3×5 poids du corps",pullLoad:"poids du corps",
      cgb:"2×8 léger",cgbLoad:"155 lb",face:"2×15",
      squat:"3×5 léger",squatLoad:"175 lb",
      deadlift:"2×5 léger",deadliftLoad:"185-205 lb",
      hip:"2×8 léger",hipLoad:"225 lb",step:"2×10/jambe facile",
      clean:"5×2 léger",cleanLoad:"145 lb",
      press:"3×5 léger",pressLoad:"105 lb",
      dip:"3×5 facile",dipLoad:"poids du corps",ctb:"3×4 facile",
      front:"3×5 léger",frontLoad:"135 lb",
      dbBench:"2×10 léger",dbBenchLoad:"50 lb / main",carry:"2×30 m modéré",
      wodNote:"flush facile"
    }
  })[week] || {label:"S1 Base",note:"",bench:"5×5",benchLoad:"240 lb",row:"4×6-8",rowLoad:"165 lb",pull:"4×5",pullLoad:"+10 à +25 lb",cgb:"3×6-8",cgbLoad:"185 lb",face:"3×15-20",squat:"5×5",squatLoad:"205 lb",deadlift:"3×5",deadliftLoad:"205-225 lb",hip:"3×8-10",hipLoad:"255-275 lb",step:"3×10/jambe",clean:"6×2",cleanLoad:"165 lb",press:"4×5",pressLoad:"125 lb",dip:"4×5",dipLoad:"+10 à +25 lb",ctb:"4×4-6",front:"4×5",frontLoad:"165-175 lb",dbBench:"3×10",dbBenchLoad:"60 lb / main",carry:"4×40 m",wodNote:"contrôlé"};
}
...
function forcePerformanceBlocks(day,week){
  ...
  if(day === "lundi") return [
    ...
    {time:"13 min",title:"B. Tirage utile",tag:"Force",kind:"accessory",
     ...
     exercises:[
       fpEx("B1. Barbell Row",p.row,p.rowLoad,"0:45 avant B2","Dos fort, buste solide, pas de swing."),
       fpEx("B2. Weighted Pull-Up",p.pull,p.pullLoad,"1:45 après B2","Strict. Si les coudes chialent : ring rows lourds.")
     ]},

    {time:"9 min",title:"C. Assistance bench",tag:"Accessoire",kind:"accessory",
     exercises:[
       fpEx("C1. Close-Grip Bench",p.cgb,p.cgbLoad,"1:00 avant C2","Triceps fort sans chercher l'échec."),
       fpEx("C2. Face Pull",p.face,"60-70 lb","0:45 après C2","Santé épaules. Rotation externe.")
     ]},
  ...
  if(day === "mardi") return [
    ...
    {time:"10 min",title:"C. Chaîne postérieure / legs",tag:"Accessoire",kind:"accessory",
     exercises:[
       fpEx("C1. Hip Thrust",p.hip,p.hipLoad,"0:45 avant C2","Pause 1 sec en haut. Fessiers, pas lombaires."),
       fpEx("C2. Box Step-Up",p.step,deload?"poids du corps":"20-35 lb / main","0:45 après C2","Rythme constant, genou stable.")
     ]},
  ...
  return [
    ...
    {time:"12 min",title:"B. Push complémentaire + carry",tag:"Accessoire",kind:"accessory",
     ...
     exercises:[
       fpEx("B1. DB Bench Press",p.dbBench,p.dbBenchLoad,"0:45 avant B2","Volume push utile sans refaire bench lourd."),
       fpEx("B2. Farmer Carry",p.carry,"lourd propre","1:15 après B2","Gainage, posture haute, grip.")
     ]},
