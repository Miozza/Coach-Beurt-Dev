...
(function(){
    ...
    sessions: [
      {
        ...
        blocks: [
          {title:"Warm-up général", time:"8 min", text:"Bike facile 5 min + respiration côtes basses + 90/90 Hip Switch + Hip CARs."},
      ...
      },
      {
        ...
        blocks: [
          {title:"Warm-up", time:"8 min", text:"Bike 5 min + Knee-to-Wall Ankle Rocks + 90/90 Hip Switch + 10 step-up poids du corps/jambe."},
          ...
          {title:"Retour au calme", time:"5 min", text:"Box Breathing + 90/90 Hip Switch."}
        ]
      },
      {
      ...
      },
      {
        ...
        blocks: [
          ...
          {title:"Retour au calme", time:"5 min", text:"90/90 Hip Switch + Couch Stretch + Box Breathing."}
        ]
      },
      {
        id: "cable_glutes",
      ...
      },
      {
        ...
        blocks: [
          {title:"Warm-up", time:"6 min", text:"Bike facile + 90/90 Hip Switch + Hip CARs."},
      ...
      },
      {
        ...
        blocks: [
          {title:"Warm-up", time:"7 min", text:"Bike facile + activation fessiers."},
      ...
      },
      {
        ...
        blocks: [
          ...
          {title:"90/90 Hip Switch + Hip CARs", time:"12 min", text:"90/90 hanches + couch stretch + pigeon modifié + respiration lente."},
  ...
  var sessionDetails = {
    ...
    recovery_glutes_mobility: {
      ...
      contenu: ["Cardio facile", "Activation", "90/90 Hip Switch + Hip CARs", "Core léger"],
