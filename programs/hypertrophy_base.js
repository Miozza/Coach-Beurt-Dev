...
function hypertrophyWeekPlan(week){
  return({
    1:{
      ...
      bench:"5×5",benchLoad:"225 lb",incline:"3×10",inclineLoad:"55-60 lb / main",lat:"3×15-20",dips:"3×6-10",pushdown:"3×12-15",
      row:"4×10",rowLoad:"115 lb",pull:"3×6-8",curl:"3×10-12",rear:"3×15-20",face:"3×15-20",
      squat:"4×6",squatLoad:"185 lb",bulgarian:"3×8/jambe",hip:"3×10",hinge:"3×10",
      clean:"6×3",cleanLoad:"155-165 lb",dbBench:"3×10",dbBenchLoad:"60 lb / main",carry:"4×40 m",hammer:"3×10-12",triOh:"3×12-15",
      wodNote:"facile à modéré"
    },
    2:{
      label:"S2 Volume",note:"Augmenter légèrement le volume. Charges solides, technique propre.",
      bench:"5×5",benchLoad:"230 lb",incline:"4×8-10",inclineLoad:"60 lb / main",lat:"4×12-20",dips:"3×8-10",pushdown:"3×12-15",
      row:"5×8-10",rowLoad:"120 lb",pull:"4×6-8",curl:"3×10-12",rear:"4×15-20",face:"3×15-20",
      squat:"5×5",squatLoad:"195 lb",bulgarian:"3×8-10/jambe",hip:"3×10",hinge:"4×10",
      clean:"6×3",cleanLoad:"160-170 lb",dbBench:"3×10-12",dbBenchLoad:"60-65 lb / main",carry:"4×40 m",hammer:"3×10-12",triOh:"3×12-15",
      wodNote:"modéré"
    },
    3:{
      label:"S3 Volume+",note:"Plus gros volume utile. Densité musculaire, pas de grind.",
      bench:"4×6",benchLoad:"235 lb",incline:"4×8-10",inclineLoad:"60-65 lb / main",lat:"4×15-20",dips:"4×6-10",pushdown:"3×12-15",
      row:"4×8",rowLoad:"125 lb",pull:"4×6-8",curl:"4×10-12",rear:"4×15-20",face:"3×15-20",
      squat:"5×5",squatLoad:"205 lb",bulgarian:"4×8/jambe",hip:"4×8-10",hinge:"4×8-10",
      clean:"6×2-3",cleanLoad:"165-175 lb",dbBench:"4×8-10",dbBenchLoad:"65 lb / main",carry:"5×40 m",hammer:"4×10",triOh:"3×12-15",
      wodNote:"contrôlé"
    },
    4:{
      label:"S4 Surcharge",note:"Charges les plus sérieuses avant l'intensité. RPE 8-9 max.",
      bench:"5×4",benchLoad:"245 lb",incline:"4×8",inclineLoad:"65 lb / main",lat:"4×12-18",dips:"4×6-8",pushdown:"3×10-15",
      row:"5×6-8",rowLoad:"130 lb",pull:"4×5-6",curl:"3×8-12",rear:"4×12-20",face:"3×15-20",
      squat:"5×4",squatLoad:"215 lb",bulgarian:"3×8/jambe",hip:"4×8",hinge:"3×8-10",
      clean:"7×2",cleanLoad:"175-185 lb",dbBench:"3×8-10",dbBenchLoad:"65-70 lb / main",carry:"5×40 m lourd",hammer:"3×8-12",triOh:"3×10-12",
      wodNote:"court, pas destructeur"
    },
    5:{
      label:"S5 Intensité",note:"Intensité maximale du cycle. Moins de volume, plus lourd.",
      bench:"6×3",benchLoad:"255 lb",incline:"3×8",inclineLoad:"65-70 lb / main",lat:"3×12-18",dips:"3×6-8",pushdown:"2×12-15",
      row:"4×6",rowLoad:"135 lb",pull:"4×5-6",curl:"3×8-10",rear:"3×12-20",face:"2×15-20",
      squat:"5×3",squatLoad:"225 lb",bulgarian:"3×8/jambe",hip:"3×8",hinge:"3×8",
      clean:"7×2",cleanLoad:"180-190 lb",dbBench:"3×8",dbBenchLoad:"70 lb / main",carry:"4×40 m lourd",hammer:"3×8-10",triOh:"2×10-12",
      wodNote:"très court"
    },
    6:{
      label:"S6 Deload",note:"Baisser le volume et garder le mouvement. Préparer la phase force.",
      bench:"3×5 léger",benchLoad:"205 lb",incline:"2×10",inclineLoad:"45-50 lb / main",lat:"2×15",dips:"2×6 facile",pushdown:"2×12",
      row:"3×8 léger",rowLoad:"95-105 lb",pull:"2×6 facile",curl:"2×12",rear:"2×15",face:"2×15",
      squat:"3×5 léger",squatLoad:"165 lb",bulgarian:"2×8/jambe",hip:"2×10 léger",hinge:"2×10 léger",
      clean:"5×2 léger",cleanLoad:"135 lb",dbBench:"2×10",dbBenchLoad:"50 lb / main",carry:"2×30 m",hammer:"2×12",triOh:"2×12",
      wodNote:"flush seulement"
    }
  })[week] || {label:"S1",note:"",bench:"5×5",benchLoad:"225 lb",incline:"3×10",inclineLoad:"55-60 lb / main",lat:"3×15-20",dips:"3×6-10",pushdown:"3×12-15",row:"4×10",rowLoad:"115 lb",pull:"3×6-8",curl:"3×10-12",rear:"3×15-20",face:"3×15-20",squat:"4×6",squatLoad:"185 lb",bulgarian:"3×8/jambe",hip:"3×10",hinge:"3×10",clean:"6×3",cleanLoad:"155-165 lb",dbBench:"3×10",dbBenchLoad:"60 lb / main",carry:"4×40 m",hammer:"3×10-12",triOh:"3×12-15",wodNote:"modéré"};
}
...
function hypertrophyBlocks(day,week){
  ...
  if(day === "lundi") return [
    ...
    {time:"10 min",title:"C. Triceps",tag:"Hypertrophie",kind:"hypertrophy",
     ...
     exercises:[
       hbEx("C1. Weighted Dips",p.dips,deload?"0 lb":"0-45 lb","0:45 avant C2","Poussée lourde triceps/lockout. Ajouter du poids seulement si reps propres."),
       hbEx("C2. Triceps Rope Pushdown",p.pushdown,"60-80 lb","1:00 après C2","Coudes fixes, extension complète, aucune balançoire.")
     ]},
  ...
  if(day === "mardi") return [
    ...
    {time:"13 min",title:"B. Tirage vertical + biceps",tag:"Superset",kind:"accessory",
     exercises:[
       hbEx("B1. Weighted Pull-Up",p.pull,deload?"poids du corps":week>=4?"+15 à +30 lb":"+0 à +20 lb","0:30 avant B2","Strict. Si les coudes tirent : ring rows lourds."),
       hbEx("B2. DB Curl",p.curl,deload?"léger":"modéré","1:15 après B2","Contrôle complet, pas d'élan du dos.")
     ]},
  ...
  if(day === "jeudi") return [
    ...
    {time:"11 min",title:"C. Chaîne postérieure",tag:"Fessiers / Ischios",kind:"accessory",
     ...
     exercises:[
       hbEx("C1. Hip Thrust",p.hip,deload?"léger":week>=4?"275-315 lb":"245-275 lb","0:45 avant C2","Pause 1 sec en haut. Fessiers, pas lombaires."),
       hbEx("C2. DB RDL",p.hinge,deload?"léger":"60-70 lb / main","1:00 après C2","Étirement ischios. Dos neutre. Aucun ego.")
     ]},
  ...
  return [
    ...
    {time:"13 min",title:"B. Push complémentaire + grip",tag:"Superset",kind:"accessory",
     ...
     exercises:[
       hbEx("B1. DB Bench Press",p.dbBench,p.dbBenchLoad,"0:30 avant B2","Contrôle, amplitude, pas d'échec."),
       hbEx("B2. Farmer Carry",p.carry,deload?"modéré":"lourd propre","1:00 après B2","Gainage fort, posture haute, grip solide.")
     ]},

    {time:"10 min",title:"C. Bras",tag:"Hypertrophie",kind:"accessory",
     exercises:[
       hbEx("C1. Hammer Curl",p.hammer,deload?"léger":"modéré à lourd","0:30 avant C2","Brachial/brachioradial, grip. Aucun swing."),
       hbEx("C2. Overhead Rope Extension",p.triOh,"50-70 lb","1:00 après C2","Longue portion triceps. Coudes propres.")
     ]},
