...
function shouldersBlocks(day,week){
  ...
  if(day==="lundi")return[
    ...
    {time:"12 min",title:"C. Triceps push",tag:"Hypertrophie",kind:"hypertrophy",
     ...
     exercises:[
       shouldersEx("C1. Weighted Dips",isDeload?"2×6-8 facile":"3×6-10",isDeload?"0 lb":"0-45 lb","0:45 avant C2","Poussée lourde triceps/lockout. Amplitude contrôlée, épaules basses. Ajouter du poids seulement si les reps restent propres."),
       shouldersEx("C2. Overhead Rope Extension",p.triOh,"50-60 lb","1:00 après C2","Longue portion triceps. Coudes stables. Étirement contrôlé, pas agressif.")
     ]},
  ...
  if(day==="jeudi")return[
    ...
    {time:"12 min",title:"B. Unilatéral + core",tag:"Jambes / Core",kind:"accessory",
     ...
     exercises:[
       shouldersEx("B1. Bulgarian Split Squat",isDeload?"2×8/jambe":"3×8-10/jambe","45-55 lb / main","0:45 avant B2","Amplitude propre, genou stable."),
       shouldersExFixed("B2. Dead Bug / Hollow Hold",isDeload?"2 séries faciles":"3 séries","poids du corps","0:45 après B2","Côtes basses, respiration contrôlée.")
     ]},
    ...
    {time:"10 min",title:"C. Chaîne postérieure",tag:"Fessiers / Ischios",kind:"accessory",
     ...
     exercises:[
       shouldersEx("C1. Hip Thrust",isDeload?"2×10 léger":p.hip,"225-275 lb","0:45 avant C2","Pause en haut. Fessiers, pas lombaires."),
       shouldersEx("C2. DB RDL",isDeload?"2×10 léger":p.hinge,"60-70 lb / main","1:00 après C2","Ischios. Dos neutre. Aucun ego.")
     ]},
