...
/*
  ...
  Usage:
    node tools/charge_diagnostics.js diagnostics/charge-engine/coach-beurt-charge-compare-shoulders3d-S4-lundi.json
*/
const fs = require('fs');
...
function main(){
  ...
  if(!file){
    console.error('Usage: node tools/charge_diagnostics.js <compare-json>');
    process.exit(1);
  }
